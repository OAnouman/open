...
/**
 * Generated class for the EditAdFormComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'edit-ad-form',
  templateUrl: 'edit-ad-form.html'
})
export class EditAdFormComponent implements OnInit {

  @Output() adEdited: EventEmitter<Ad>;
  @Input() ad: Ad;
  tagsList = Utils.TAGS;
  tagSelectOptions: {};
  ...
  constructor(private _formBuilder: FormBuilder,
    ...
    this.adEdited = new EventEmitter<Ad>();
